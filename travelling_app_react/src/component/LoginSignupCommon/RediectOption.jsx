...
function RediectOption({ isLogin, handleFun, isSubmitting }) {
    return (
        <div className="redirectOption">
            <Button variant="contained" disabled={isSubmitting} color="primary" sx={{ margin: '1rem' }} onClick={handleFun}> {isLogin ? 'Login' : 'SignUp'}</Button>
